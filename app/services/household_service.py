...
from app.schemas import HouseholdCreate, UserCreate
...
class HouseholdService:
    ...
    async def create_household_and_admin(self, household_data: HouseholdCreate) -> Household:
        ...
        household_and_admin = await self.get_household_by_id(household.id, include_users=True)

        return household_and_admin

        
    async def get_household_by_id(self, household_id: UUID, include_users: bool = False) -> Household:
        return await self.household_repo.get_household_by_id(household_id, include_users)